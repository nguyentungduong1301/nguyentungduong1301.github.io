...
|---|---|---|---|---|
| Kiến thức | - Tốt nghiệp đại học Công nghệ thông tin, Điện- Điện tử viễn thông, Tự động hóa, Kỹ thuật máy tính hoặc lĩnh vực liên quan<br>- Kiến thức/kinh nghiệm về lập trình ứng dụng xử lý hình ảnh| - Tốt nghiệp Đại học chuyên ngành Công nghệ thông tin, Phân tích dữ liệu hoặc lĩnh vực tương đương<br>- Kiến thức về thiết kế, xây dựng và tối ưu hệ thống Data Warehouse, Lakehouse<br>- Data Modeling, Database Tuning | - Tốt nghiệp đại học chuyên ngành An toàn thông tin<br>- Nắm vững các nhóm lỗ hổng phổ biến của ứng dụng web và API, nguyên lý khai thác, mức độ ảnh hưởng và biện pháp khắc phục; hiểu quy trình đánh giá hộp trắng, hộp xám, hộp đen<br>- Kiến thức về lập trình an toàn ứng dụng web<br>- Kiến thức nền tảng về mạng, giao thức HTTP/HTTPS, hệ điều hành Windows/Linux, cơ sở dữ liệu, kiến trúc ứng dụng và các cơ chế xác thực, phân quyền, quản lý phiên | một phần |
| Kỹ năng | - Lập trình C/C++ trên Linux<br>- Đọc hiểu và viết báo cáo bằng tiếng Anh<br>- Kỹ năng làm việc theo nhóm<br>- Lập trình ứng dụng trên các thiết bị di động, thiết bị nhúng<br>- Lập trình và phát triển data pipeline| - Sử dụng thành thạo SQL, tối ưu truy vấn, thiết kế data model và cải thiện hiệu năng cơ sở dữ liệu<br>- Phân tích nguồn dữ liệu<br>- Training nhân viên mới và viết các tài liệu kỹ thuật | - Thực hiện kiểm thử xâm nhập (hộp đen, hộp xám, hộp trắng) và đánh giá an toàn thông tin đối với ứng dụng web, API, ứng dụng di động<br>- Đọc hiểu mã nguồn<br>- Phân tích lưu lượng, mã nguồn, webshell và dấu hiệu khai thác<br>- Lập kế hoạch kiểm thử, lập báo cáo kỹ thuật, phân tích và trình bày kết quả<br>- Đọc hiểu tài liệu kỹ thuật tiếng Anh<br>- Tư vấn biện pháp xử lý và kiểm tra lại sau khi khắc phục| một phần |
| Thái độ | - Chịu được áp lực cao trong công việc | - Đề cao trách nhiệm trong công việc, ý thức chất lượng sản phẩm tốt<br>- Đam đam mê tìm tòi nghiên cứu học hỏi công nghệ mới, phát triển bản thân | - Tuân thủ phạm vi, quy trình, yêu cầu bảo mật thông tin và quy tắc đạo đức nghề nghiệp <br>- Chủ động nghiên cứu, cập nhật kỹ thuật khai thác lỗ hổng và xu hướng an toàn thông tin mới | một phần|
| Công cụ | - Môi trường/Hệ điều hành: Linux, Windows, MacOS <br>- Công cụ phát triển: Microsoft Visual Studio, Qt framework, Visual Studio code <br>- CSDL & Hạ tầng: MySQL, SQLite, cloud server, GPU, camera, board mạch, robot |- Ngôn ngữ: Python, SQL<br>- Công cụ chuyên môn: Công cụ ETL, công cụ BI<br>- Môi trường: Data Warehouse, Lakehouse, Big Data | - Ngôn ngữ/nền tảng lập trình phục vụ phân tích, tự động hóa và kiểm thử<br>- Hệ điều hành: Windows/Linux<br>- Giao thức/Công nghệ: HTTP/HTTPS, Web, API, Webshell| một phần |

## Ba tin tuyển dụng

| # | Công ty | Vị trí | Đường dẫn | Ngày truy cập |
|---|---|---|---|---|
| 1 | TNHH Greystone Data Systems Việt Nam | Lộ 62, đường 2, KCX Linh Trung 2, Q.Thủ Đức, Tp HCM | https://careerviet.vn/vi/tim-viec-lam/software-engineer.35C82DDF.html| 10/9/2026 |
